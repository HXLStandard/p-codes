...
ogr2ogr -f GeoJSON D:/uncs/p-codes/geojson/GCC/ADM1.geojson PG:"host=localhost dbname=geodatabase user=postgres password=postgres" -sql "SELECT gid,  name, namealt, namear, namearalt, iso3, idprogres, idfocus,  idocha, idgaul, idicrc, idnatural,  geom FROM unhcr.admin1rev WHERE  iso3='BAH' OR iso3='OMN' OR iso3='UAE' OR iso3='SAU' OR iso3='KWT' OR iso3='QAT'"
